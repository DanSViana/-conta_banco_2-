    ...
    while True:
                        ...
                        while True:
                            ...
                            match operacao:
                                ...
                                case '2':
                                    ...
                                    print('Depósito afetuado com sucasso.')
                                    print(f'Saldo atual: R$ {saldo:,.2f}')
                                    continue
                                # saque
                                case '3':
                                    valor = str(input('Valor do seque: R$ '))
                                    valor = float(valor.replace(',','.'))
                                ...
                                case _:
                                    ...
                                    continue
                    # avança para o próximo loop caso o nome seja encontrado
                    else:
                        continue
        ...
        # exclui correntista
            ...
            try:
                ...
                print('Não foi possível daletar conta.')
            continue
        # encerra programa
        elif opcao == '5':
            break
